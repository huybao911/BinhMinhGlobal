                        ...
                        <Box display={'flex'} flexDirection={'column'} sx={{ margin: "0 15px 0 40px" }}>
                            ...
                            <Grid container>
                                {_DATA.currentData().map((product: any) =>
                                    <Grid xs={6} key={product._id} style={{ margin: "20px 0", maxWidth: "410px" }} >
                                        <Box className="photo">
            ...
            <Box >
                <Box>
                    <Box>
                        ...
                        <Box sx={{ fontSize: "25px", fontWeight: "bold", margin: "30px 0 30px 0px", display: "flex", justifyContent: "left" }}>SẢN PHẨM</Box>
